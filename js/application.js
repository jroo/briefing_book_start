...
Application.prototype.populateDb = function() {
    ...
    this.localDb.transaction(
        function(transaction) {
            ...
            transaction.executeSql("INSERT INTO Resource (id, timestamp, title, source, type, url) VALUES('http://www.nationalreview.com/articles/253245/threat-new-start-keith-b-payne', '2010-11-15', 'The Threat of New START', 'nro', 'editorial', 'http://www.nationalreview.com/articles/253245/threat-new-start-keith-b-payne')", [], nullDataHandler, errorHandler);
            transaction.executeSql("INSERT INTO Resource (id, timestamp, title, source, type, url) VALUES('http://www.nationalreview.com/articles/253983/new-start-mischaracterization-and-misdirection-keith-b-payne', '2010-11-29', 'New START Mischaracterization and Misdirection', 'nro', 'editorial', 'http://www.nationalreview.com/articles/253983/new-start-mischaracterization-and-misdirection-keith-b-payne')", [], nullDataHandler, errorHandler);
            transaction.executeSql("INSERT INTO Resource (id, timestamp, title, source, type, url) VALUES('http://www.nationalreview.com/corner/254358/why-i-may-filibuster-new-start-sen-jim-demint', '2010-12-02', 'Jim DeMint: Why I May Filibuster New START', 'nro', 'editorial', 'http://www.nationalreview.com/corner/254358/why-i-may-filibuster-new-start-sen-jim-demint')", [], nullDataHandler, errorHandler);
            transaction.executeSql("INSERT INTO Resource (id, timestamp, title, source, type, url) VALUES('http://www.washingtonpost.com/wp-dyn/content/article/2010/12/01/AR2010120104598.html?hpid=opinionsbox1', '2010-12-02', 'The Republican case for ratifying New START', 'wp', 'editorial', 'http://www.washingtonpost.com/wp-dyn/content/article/2010/12/01/AR2010120104598.html?hpid=opinionsbox1')", [], nullDataHandler, errorHandler);            
        }
    );
}
